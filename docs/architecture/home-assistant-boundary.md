...
| Person entity, `user_id` linkage, administrator and local-access-only flags | Person integration | Roles, authority classes, evidence association | No household role model; administrator is binary | **DL-39**, **DL-40** |
