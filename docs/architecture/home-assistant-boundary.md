...
| Person entity, `user_id` linkage, administrator and local-access-only flags | Person integration | Roles, authority classes, evidence association | No household role model; administrator is binary — **never treated as care or proxy-consent authority** (**DL-56**, **OD-76**) | **DL-39**, **DL-40**, **DL-56** |
