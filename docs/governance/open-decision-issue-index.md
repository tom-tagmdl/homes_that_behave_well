...
| **OD-13** | Contextual Vocabulary Inheritance | Open — Governance Required | **#138** | #135, #136 (**resolved as DL-67**, related not blocking), #133 (**resolved as DL-69**, related not blocking) | DL-09, DL-10; OD-14 resolved; **DL-69 accepts Vocabulary as first-class and states a context-precedence order that explicitly excludes a Household-wide inherited tier — OD-13 alone decides whether that tier, override/shadowing, collision, transitivity through a Merged Room, and language-specific morphology are accepted** |
