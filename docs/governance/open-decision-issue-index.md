...
| **OD-13** | Contextual Vocabulary Inheritance | Open — Governance Required | **#138** | #135, #136 (**resolved as DL-67**, related not blocking) | DL-09, DL-10; OD-14 resolved |
...
| **OD-62** | Governed Conversational Retrieval | Open — Governance Required | **#133** | #103 (**resolved as DL-66**, related not blocking), #79, #80, #81, #104, #146 | DL-33, DL-34, DL-35, DL-36, DL-46; **DL-66 supplies which entities are voice-discussable/targetable/retrievable at all — OD-62 still owns retrieval scope, custom sentences/intents, and authority/privacy filtering** |
...
| **OD-70** | Merged Room Native Representation | Open — Governance Required | **#143** | #136 (**resolved as DL-67**, related not blocking), #141 | DL-12, DL-13, DL-31; **DL-67 confirms a Merged Room is a curated single-membership interaction context — OD-70 still owns whether it warrants a native Home Assistant projection at all** |
