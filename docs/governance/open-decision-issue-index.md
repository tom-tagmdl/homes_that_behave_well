...
| **OD-62** | Governed Conversational Retrieval | Open — Governance Required | **#133** | #103 (**resolved as DL-66**, related not blocking), #143 (**resolved as DL-68**, related not blocking), #79, #80, #81, #104, #146 | DL-33, DL-34, DL-35, DL-36, DL-46; **DL-66 supplies which entities are voice-discussable/targetable/retrievable at all; DL-68 supplies the Merged-Room-aware command-resolution order up to the vocabulary match — OD-62 still owns retrieval scope, custom sentences/intents, command-routing/no-match/native-fallback behaviour, and authority/privacy filtering** |
