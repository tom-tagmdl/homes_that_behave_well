...
| **OD-52** | Audience Specification | Open — Governance Required | **#100** | #104, #113, #108, #138 (**resolved as DL-70**, related not blocking) | DL-28, DL-29, DL-33, DL-34; **DL-70 confirms Vocabulary resolution carries no permission implication and routes the "default Guest, exceptions-only" Asset-engagement proposal here — OD-52 still owns audience specification and any Asset-engagement default** |
