...
| **OD-15** | Identity Assertion Lifetime | Open — Governance Required | **#96** | #89 (**resolved as DL-59**, related not blocking), #90 (**resolved as DL-63**, related not blocking) | DL-32, DL-36, DL-37, DL-38, DL-39; **DL-63 consumes OD-15's own recorded cross-purpose-eligibility boundary without redefining it — this decision remains OD-15's own** |
...
| **OD-60** | Repairs Adoption Scope | Open — Governance Required | **#140** | #146 | DL-16, DL-30, DL-41, DL-46; **DL-60 clarifies that ordinary environmental-proposal divergence is a configuration condition, not a Repairs defect, by itself; DL-63 adds that a persistent Truth conflict is evaluated against OD-60's own administrator-correctable-defect criteria separately from the runtime Fact outcome — ordinary transient disagreement is not automatically Repairs-eligible** |
