...
| **OD-59** | Exposure Precedence | Open — Research Required | **#103** | #140 (**resolved as DL-65**, related not blocking), #146 | DL-11, DL-31; OD-14 precedent; **DL-60 is an analogous, not identical, precedent (environmental-slot proposal vs. Assist exposure); DL-65 supplies the general rule that configuration divergence is informational unless it independently meets the genuine-defect test — OD-59 still owns whether Assist-vs-HTBW divergence specifically is even reported that way** |
